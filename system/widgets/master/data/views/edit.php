...
<script>
	$("document").ready(function(){
		...
		$(".save").click(function(){
			widget_load('<?php echo $this -> widgetId; ?>','save',widget_get_form_data($("form[name='editform_<?php echo $this -> widgetId; ?>']")));
		});

		$(".delete").click(function(){
			var id = $("#<?php echo $this -> widgetId; ?> input[name='id']").val();
