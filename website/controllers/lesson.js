	...
	function LessonController( $scope, UserData, LanMgr)
	{
		...
		$scope.classTables = [
			...
			},
			{
				...
				Column2: {text: "9:00-12:00<br><br>舞團課程", style:"classDance"},
				Column3: {text: "9:00-12:00<br><br>舞團課程", style:"classDance"},
				Column4: {text: "9:00-12:00<br><br>舞團課程", style:"classDance"},
				Column5: {text: "9:00-12:00<br><br>舞團課程", style:"classDance"},
			...
			},
			{
				...
				Column1: {text: "2:00-5:00<br><br>舞團排練", style:"classDance"},
				Column2: {text: "2:00-5:00<br><br>舞團排練", style:"classDance"},
				Column3: {text: "", style:"classNone"},
				Column4: {text: "", style:"classNone"},
				Column5: {text: "2:00-5:00<br><br>舞團排練", style:"classDance"},
				Column6: {text: "2:00-5:00<br><br>兒童舞團<br>芭蕾<br><a href='#/teacher/4'>青瀠</a>", style:"classChildDG"},
				Column7: {text: "", style:"classNone"},
			},
			{
				Column0: {text: "晚<br>上", style:"classTime classTimeUp"},
				Column1: {text: "6:00-7:30<br><br>中級芭蕾<br>(10-12歲)<br><a href='#/teacher/8'>夢蝶</a>", style:"classDanceBL"},
				Column2: {text: "6:30-8:00<br><br>成人現代<br><a href='#/teacher/0'>文歆</a>", style:"classDanceAD"},
				Column3: {text: "6:30-7:30<br><br>進階芭蕾<br>(13歲以上)<br><a href='#/teacher/0'>文歆</a>", style:"classDanceBL"},
				Column4: {text: "6:30-7:30<br><br>初級中國舞<br>(7-9歲)<br><a href='#/teacher/0'>文歆</a>", style:"classDanceBL"},
				Column5: {text: "6:00-7:30<br><br>進階中國舞<br>(13歲以上)<br>黃平", style:"classDanceBL"},
				Column6: {text: "", style:"classNone"},
				Column7: {text: "", style:"classNone"},
			},
			{
				Column0: {text: "", style:"classTime classTimeDown"},
				Column1: {text: "7:30-9:00<br><br>中級現代<br>(10-12歲)<br><a href='#/teacher/6'>敏妙</a>", style:"classChildModern"},
				Column2: {text: "8:00-9:00<br><br>兒童MV<br><a href='#/teacher/8'>夢蝶</a>", style:"classDanceBL"},
				Column3: {text: "7:30-9:00<br><br>成人芭蕾<br><a href='#/teacher/0'>文歆</a>", style:"classDanceAD"},
				Column4: {text: "8:00-9:00<br><br>初級芭蕾<br>(7-9歲)<br><a href='#/teacher/5'>彥徵</a>", style:"classDanceBL"},
				Column5: {text: "7:30-8:30<br><br>成人街舞<br>(15歲以上)<br><a href='#/teacher/1'>小七</a>", style:"classDanceAD"},
				Column6: {text: "", style:"classNone"},
				Column7: {text: "", style:"classNone"},
			},
		];
		...
		$scope.classTables2 = [
			...
			{
				Column0: {text: "上<br>午", style:"classTime"},
				Column1: {text: "10:30-11:30<br><br>幼兒律動<br>(3-6歲)<br><a href='#/teacher/5'>彥徵</a>", style:"classBaby"},
				Column2: {text: "10:30-11:30<br><br>幼兒律動<br>(3-6歲)<br><a href='#/teacher/5'>彥徵</a>", style:"classBaby"},
				Column3: {text: "", style:"classNone"},
				Column4: {text: "10:00-11:00<br><br>兒童瑜珈<br>(3-7歲)<br>Dora", style:"classDanceAD"},
				Column5: {text: "10:30-11:30<br><br>幼兒律動<br>(3-6歲)<br><a href='#/teacher/5'>彥徵</a>", style:"classBaby"},
			...
			{
				Column0: {text: "晚<br>上", style:"classTime classTimeUp"},
				Column1: {text: "6:30-7:30<br><br>兒童街舞<br>(11-15歲)<br><a href='#/teacher/1'>小七</a>", style:"classDanceBL"},
				Column2: {text: "6:30-7:00<br><br>兒童中國舞<br>(10-12歲)<br><a href='#/teacher/2'>云湘</a>", style:"classDanceBL"},
				Column3: {text: "7:00-8:00<br><br>成人有氧", style:"classDanceAD"},
				Column4: {text: "6:00-7:00<br><br>兒童街舞<br>(7-10歲)<br><a href='#/teacher/1'>小七</a>", style:"classDanceBL"},
				Column5: {text: "", style:"classNone"},
				Column6: {text: "", style:"classNone"},
				Column7: {text: "", style:"classNone"},
			},
			{
				Column0: {text: "", style:"classTime classTimeDown"},
				Column1: {text: "7:30-8:30<br><br>幼兒律動<br>(3-6歲)<br><a href='#/teacher/3'>旻君</a>", style:"classBaby"},
				Column2: {text: "7:30-8:30<br><br>幼兒律動<br>(3-6歲)<br><a href='#/teacher/3'>旻君</a>", style:"classBaby"},
				Column3: {text: "8:00-9:00<br><br>兒童MV<br><a href='#/teacher/5'>彥徵</a>", style:"classDanceBL"},
				Column4: {text: "8:00-9:00<br><br>成人瑜珈<br><a href='#/teacher/0'>文歆</a>", style:"classDanceAD"},
				Column5: {text: "", style:"classNone"},
				Column6: {text: "", style:"classNone"},
				Column7: {text: "", style:"classNone"},
			},
